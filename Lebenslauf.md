...
* **Frontend:** JavaScript (ES6+), React, Next.js, HTML5, CSS3, Tailwind CSS
* **Backend & Frameworks:** Node.js, Express.js, NestJS, Python, Django
* **Datenbanken:** PostgreSQL, MongoDB, MySQL, SQLite, SQL
* **Künstliche Intelligenz (AI) & Tools:** AI-assisted Development (Cursor), LLM API Integration (OpenAI, Claude), Prompt Engineering, Agentic Workflows (LangChain, n8n)
* **Testing & Automatisierung:** Playwright, Puppeteer, QA & Testautomatisierung
* **Werkzeuge & Infrastruktur:** Git, GitHub, GitLab, RESTful APIs, Docker, Linux (Ubuntu)
...
* **09/2008 – 07/2012** **Master-Abschluss** *V. N. Karazin Kharkiv National University, Ukraine*
...
* **Englisch:** B2 (Fließend in Wort und Schrift, sichere Nutzung der technischen Dokumentation)
* **Deutsch:** B1 (Gute Kenntnisse, aktive Vorbereitung auf das B2-Beruf-Zertifikat)
